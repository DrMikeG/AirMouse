...
// Set up for data display
  ...
  Serial.print("\nMPU6050");
  Serial.print("\nI AM\n");
  Serial.print(c);Serial.print(" HEX");  
  Serial.print("\nI Should Be\n");
...
//     
    ...
    initMPU6050(); Serial.println("\nMPU6050 initialized for active data mode...."); // Initialize device for active mode read of acclerometer, gyroscope, and temperature
//  //tft.fillScreen(ILI9341_WHITE);
    //tft.setTextSize(2);
   }
   else
   {
    Serial.print("\nCould not connect to MPU6050: 0x");
